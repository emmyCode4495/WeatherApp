...
fun CityRow(favorite: Favorites,
        ...
        androidx.compose.material.Surface(androidx.compose.ui.Modifier
            .padding(3.dp)
            .fillMaxWidth()
            .height(50.dp)
            .clickable {
        ...
        color = Color(0xFFB2DFDB)) {
            Row(androidx.compose.ui.Modifier
                .fillMaxWidth(),
            verticalAlignment = Alignment.CenterVertically,
            horizontalArrangement = Arrangement.SpaceEvenly) {
                Text(text = favorite.city,
                    androidx.compose.ui.Modifier.padding(start = 4.dp))


                Surface(androidx.compose.ui.Modifier.padding(0.dp),
                shape = CircleShape,
                color = Color(0xFFDE1E3E1)) {
                    Text(text= favorite.country,
                        androidx.compose.ui.Modifier.padding(4.dp),
